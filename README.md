...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/zope.deprecation-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/zope.deprecation-feedstock)
...
Once the `conda-forge` channel has been enabled, `zope.deprecation` can be installed with:

```
conda install zope.deprecation
```

It is possible to list all of the versions of `zope.deprecation` available on your platform with:
